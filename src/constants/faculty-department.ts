...
// // type FacultyDepartmentMap = typeof facultyDepartmentMap[number];
// // export type FacultyName = keyof FacultyDepartmentMap;
// // type DepartmentList<F extends FacultyName> =
// //   Extract<FacultyDepartmentMap, Record<F, readonly string[]>>[F];

// // export const getFaculties = () => {
// //   return facultyDepartmentMap.map((item) => Object.keys(item)[0]);
// // };

// // export const getDepartmentsByFaculty = <T extends FacultyName>(faculty: T):DepartmentList<T> => {
// //   const facultyItem = facultyDepartmentMap.find(
// //     (item) => Object.keys(item)[0] === faculty,
// //   );
// //   if(!facultyItem) throw new Error("failed to get department")
// //   return Object.values(facultyItem)[0] ;
// // };
...
//   const facultyItem = facultyDepartmentMap.find(item => Object.keys(item)[0] === faculty);
//   return facultyItem ? Object.values(facultyItem)[0] : [];
// };
