...
//   subscription_events,
//   // transaction_events,
// } from './../src/constants/paystack-events';
...
//       event: body,
//     });
//     if (body.event === subscription_events.disabled) {
//       console.log('customers subscription has been disabled');
//       const event: Subscription_Disable_Event = body.event;

//       try {
//         // ? call a mutation that handles the subscription cancellation
//         await c.env.runMutation(internal.payment.deleteSubscription, {
...
//         });
//       } catch (error) {
//         console.log('Error in deleting a subscription', error);
//       }
//     }

//     // Handle subsequent charges to the lecturers card
//     if (body.event === invoice_events.update) {
//       // const event: = b ody.event.data
//     }
