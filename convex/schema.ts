...
const applicationTables = {
  ...
  courses: defineTable({
    ...
    excludedStudents: v.array(v.object({
      classListId: v.id("classLists"),
      registrationNumber: v.string(),
      reason: v.optional(v.string()),
    })),
    attendanceList: v.array(v.object({
      fullName: v.string(),
      registrationNumber: v.string(),
      gender: v.union(v.literal("Male"), v.literal("Female"), v.literal("Other")),
      faculty: v.string(),
  ...
  attendanceRecords: defineTable({
    ...
    location: v.optional(v.string()),
    method: v.union(v.literal("qr"), v.literal("manual"), v.literal("proximity")),
  })
  ...
  courseReports: defineTable({
    courseId: v.id("courses"),
    reportType: v.union(v.literal("completion"), v.literal("analytics"), v.literal("attendance")),
    data: v.object({
      ...
      bottomPerformers: v.array(v.object({
        studentId: v.string(),
        studentName: v.string(),
        attendancePercentage: v.number(),
      })),
      sessionBreakdown: v.array(v.object({
        sessionId: v.string(),
        sessionName: v.string(),
        date: v.number(),
